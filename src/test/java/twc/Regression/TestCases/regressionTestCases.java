...
//	public void verify_enabling_optout_of_sale_for_Criteo_SDK() throws Exception {
	...
	public void beforeClass() throws Exception {	
		...
		proxy.clearCharlesSession();
AppiumFunctions.LaunchAppWithFullReset();
AppiumFunctions.enterRequiredUserGroup("package twc.Regression.TestCases;
...
/* =======================================all feed ad calls test cases started======================================================================================*/
	...
	public void Verify_Daily_Details_ad_call_amazon_bid_id() throws Exception {
		...
		Functions.verifyAAX_SlotId("10day");
	}
	...
	public void Verify_amazon_aax_Health_BoatAndBeach_Details_adcall() throws Exception {
		...
		// Functions.verifyAAX_SlotId("Smoke", "Daily(10day)");
	Functions.verifyAAX_SlotId("Health(boatAndBeach)");
	...
	public void preConditions_Criteo_SDKl() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"=========================== Criteo SDK  preconditions====================");
	...
	/*@Test(priority = 459, enabled = false)
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_cpm_parameter_with_HealthcoldAndFluArticles_gampad_call()
		...
		Functions.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Health(coldAndFluArticles)", "cpm", true);
	}
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_size_parameter_with_HealthcoldAndFluArticles_gampad_call()
		...
		Functions.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Health(coldAndFluArticles)", "size", true);
	}

	@Test(priority = 461, enabled = false)
	...
	public void Verify_Criteo_SDK_inapp_v2_Call_displayUrl_parameter_with_HealthcoldAndFluArticles_gampad_call()
		...
		Functions.validate_Criteo_SDK_inapp_v2_call_param_value_with_gampad_param_value("Health(coldAndFluArticles)", "displayUrl", true);
	}*/
	...
	@Description("Verify Criteo SDK inapp v2 call when Optout for sale")
	public void Verify_Criteo_SDK_inapp_v2_Call_when_Optout_for_sale() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"=========================== Criteo SDK inapp/v2 call when Optout for sale ====================");
		System.out.println("****** Criteo SDK inapp/v2 call when Optout for sale validation Started");
		logStep("****** Criteo SDK inapp/v2 call when Optout for sale validation Started");
		Functions.verifyCriteo_inapp_v2_Call("Criteo", false);

	}

	@Test(priority = 903, enabled = false)
	@Description("Verify Criteo SDK config app call when Optout for sale")
	public void Verify_Criteo_SDK_config_app_Call_when_Optout_for_sale() throws Exception {
		System.out.println("==============================================");
		System.out.println(
				"=========================== Criteo SDK config/app call when Optout for sale====================");
		System.out.println("****** Criteo SDK config/app call when Optout for sale validation Started");
		logStep("****** Criteo SDK config/app call when Optout for sale validation Started");
	Functions.verifyCriteo_config_app_Call("Criteo", false);
	...
	@Description("Enabling Preconfiguration for Criteo SDK Validation Non US")
	public void enable_PreConfiguration_for_Criteo_SDK_Non_US() throws Exception {
		System.out.println("==============================================");
		System.out.println("****** Enable Preconfiguration for Criteo SDK Non US");
		logStep("Enable Preconfiguration for Criteo SDK Non US");
		proxy.quitCharlesProxy();
		//this.configFile = this.rewriteRuleToOverrideGeoIpCountry(CRITEO_NONUS_CONFIG_FILE_PATH, "UK");
		proxy = new CharlesProxy("localhost", 8111, CRITEO_NONUS_CONFIG_FILE_PATH);
		proxy.startCharlesProxyWithUI();
		proxy.disableRewriting();
		proxy.stopRecording();
		proxy.disableMapLocal();
...
AppiumFunctions.LaunchAppWithFullReset();
		...
		/// still need to modify below code to download the app from firebase....
		proxy.clearCharlesSession();
		AppiumFunctions.Kill_Launch_App();
		/*
		 * Since user group is not required hence commented below lines of code..
		 * Functions.clear_Airlock_Cache(); Functions.close_launchApp();
		 * Functions.select_Airlock_UserGroup("Criteo"); Functions.close_launchApp();
		 */
		AppiumFunctions.enter_requiredLocation("New York");
		Thread.sleep(5000);
		CharlesFunctions.archive_folder("Charles");
		Thread.sleep(5000);
		proxy.getXml();
	...
	@Test(priority = 952, enabled = false)
	@Description("Verify Criteo SDK inapp v2 call for Non US")
	public void Verify_Criteo_SDK_inapp_v2_Call_Non_US() throws Exception {
		System.out.println("==============================================");
		System.out.println("=========================== Criteo SDK inapp/v2 call for Non US ====================");
		System.out.println("****** Criteo SDK inapp/v2 call for Non US validation Started");
		logStep("****** Criteo SDK inapp/v2 call for Non US validation Started");
	Functions.verifyCriteo_inapp_v2_Call("Criteo", false);

	}

	@Test(priority = 953, enabled = false)
	@Description("Verify Criteo SDK config app call for Non US")
	public void Verify_Criteo_SDK_config_app_Call_Non_US() throws Exception {
		System.out.println("==============================================");
	...
	public static void goingalModules() throws Exception {
			}
